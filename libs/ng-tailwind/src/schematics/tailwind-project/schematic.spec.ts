...
describe.skip('ng-tailwind schematic', () => {
  ...
  beforeEach(async() => {
    ...
    appTree = await testRunner.callRule(
  ...
  it('should run successfully', async () => {
    const resultTree = await testRunner.runSchematicAsync('tailwind-project', options, appTree).toPromise();
    ...
    const moduleContent = resultTree.readContent('/apps/sample-app/ng-tailwind.js');
